namespace BarbellBarPlugin.Core.Model
{
    /// <summary>
    /// Параметры грифа штанги.
    /// </summary>
    public class BarbellBarParameters
    {
        /// <summary>
        ...
        /// <summary>
        /// Длина разделителя, мм.
        /// </summary>
        public double SeparatorLength { get; }

        /// <summary>
        /// Длина ручки (хвата), мм.
        /// </summary>
        ...
        public double TotalLength
        {
            get
            {
                return 2 * SleeveLength + 2 * SeparatorLength + HandleLength;
            }
        }
